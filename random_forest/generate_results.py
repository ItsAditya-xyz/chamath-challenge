# generate_results_rf.py — for generating private predictions using Random Forest
...
print(f"📝 Output will be saved to private_final_results_rf.txt")

results_file = "private_final_results_rf.txt"
